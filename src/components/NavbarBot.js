        ...
        <nav className="p-0 navbar navbar-dark navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom" id="navbarbawah">
            <ul className="navbar-nav nav-justified w-100">
                <li className="nav-item">
                    <a href="#" className="nav-link text-center"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em"
                    ...
                    </svg><span className="small d-block">Beranda</span></a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                    ...
                    </svg><span className="small d-block">Akun</span></a>
                </li>
            </ul>
        </nav>
    )
